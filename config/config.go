...
type EnvConfig struct {
	...
	GoogleTranslateUrl    string `validate:"required" mapstructure:"GOOGLE_TRANSLATE_URL"`
	RapidAPITranslateHost string `validate:"required" mapstructure:"RAPID_API_TRANSLATE_HOST"`
}
